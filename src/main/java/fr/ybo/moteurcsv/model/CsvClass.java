...
public class CsvClass {
	...
	public CsvClass(String separator, Class<?> clazz) {
		...
		try {
            ...
            throw new MoteurCsvException("Error while getting the default constructor of " + clazz.getSimpleName()
	...
	public char getSeparatorWithoutEscape() {
		...
		if (separatorWithoutEscape.length() != 1) {
			throw new MoteurCsvException("The separator " + separatorWithoutEscape + " contains more than 1 character.");
		}
